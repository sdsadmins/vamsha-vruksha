...
export const DASHBOARD_ACTIVITY = [
  ...
  {
    id: 2,
    user: "Shri Narayanarao Suvarna",
    action: "verified the lineage of",
    detail: "Rohit Suvarna — Chickpete branch",
    time: "Yesterday",
    type: "tree",
    avatar: "NS",
    photo: PX(17815020),
...
export const CONFLICT_CASES = [
  {
    ...
    discussion: [
      { author: "Shri Narayanarao Suvarna", role: "Elder", text: "I've reviewed both submissions. The temple trust document from 1924 is the stronger evidence — it has Ramachandra Rao as father with witness signatures.", time: "2 days ago", photo: PX2(17815020) },
      { author: "Smt. Vijaya Vernekar", role: "Member", text: "The Mysore branch has the original family trunk documents. I can bring them to the next Samaj meeting for physical review.", time: "1 day ago", photo: PX2(11138457) },
    ],
  },
  {
    id: "ck-2",
    type: "Parentage",
    subject: "Savitri Bai Suvarna",
    born: "1910",
    died: "1994",
    photo: PX2(11138457),
    ...
    discussion: [
      { author: "Vasudeva Vernekar", role: "Elder, Kumta Branch", text: "The 1985 oral recording is important cultural evidence but birth certificates take precedence in lineage records per our 2019 governance guidelines.", time: "3 days ago", photo: PX2(2601464) },
      { author: "Arjun Shirodkar", role: "Member", text: "I have the original birth certificate in the family trunk. Amala Devi is clearly listed as mother. I can courier a notarised copy.", time: "1 day ago", photo: PX2(7345266) },
    ],
  },
];
